...
export default function LogoAnimation() {
  ...
  const infiniteTeams = [...FC_TEAMS, ...FC_TEAMS];
  return (
    <div className="relative flex justify-center items-center mx-auto mb-50 w-full">
      <div
      ...
      <div className={styles.logos}>
        {infiniteTeams.map((team) => (
          <img
            ...
            grayscale-75 hover:opacity-100 hover:grayscale-0 
      ...
      <div
        className="absolute left-0 top-0 h-full w-[150px] z-20 pointer-events-none
                   bg-gradient-to-r from-secondary to-transparent"
      ></div>
      <div
        className="absolute right-0 top-0 h-full w-[150px] z-20 pointer-events-none
